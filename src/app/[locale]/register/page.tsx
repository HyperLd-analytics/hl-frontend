  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-4">
      <Card className="w-full max-w-sm space-y-4">
        <h1 className="text-xl font-semibold">{t("register")} Hyperliquid Lens</h1>
        ...
        <Button className="w-full" onClick={onRegister} disabled={loading}>
          {loading ? t("register") + "中..." : t("register")}
        </Button>
        {(error || localError) && (
          <PageError title={t("register") + "失败"} message={error?.message || localError} />
        )}
